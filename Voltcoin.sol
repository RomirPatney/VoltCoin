...
contract VoltCoin is StandardToken {
    ...
    */
    ...
    uint8 public decimals;                //How many decimals to show. ie. There could 1000 base units with 3 decimals. Meaning 0.980 SBX = 980 base units. 
...
//contract name above is also TutorialToken instead of ERC20Token
    ...
    function VoltCoin() {
        ...
        name = "VoltCoin";                                   // Set the name for display purposes
        decimals = 10;                            // Amount of decimals for display purposes
        symbol = "VOLT";                               // Set the symbol for display purposes
    }
